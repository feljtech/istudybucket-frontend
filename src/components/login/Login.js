        ...
        <div className="border shadow rounded p-5 max-w-md w-full space-y-8">
          ...
          <form className="mt-8 space-y-6" action="#" method="POST">
            ...
            <div>
              <button
                type="submit"
                className="group uppercase font-semibold relative w-full flex justify-center py-2 px-4 border border-transparent text-sm rounded-md text-white bg-green-500 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
              >
                Sign in
              </button>
              <hr className="border" />
