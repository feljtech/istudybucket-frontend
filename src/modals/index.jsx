...
const ModalBase = ({ children, title }) => {
	...
	return (
		<div
			id="modal-container"
			className="fixed top-5 left-0 w-full h-screen flex justify-center items-center backdrop-filter backdrop-blur backdrop-brightness-50 z-40"
		>
			<div
				id="overlay"
				onClick={closeModal}
			...
			<div className="bg-white w-6/7 md:w-3/5">
				...
				<div id="modal-child" className="p-2">
